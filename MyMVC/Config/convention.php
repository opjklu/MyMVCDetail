...
return  array(
    ...
    'COOKIE_PREFIX'         =>  'wq_',      // Cookie前缀 避免冲突

    /* 默认设定 */
    'DEFAULT_M_LAYER'       =>  'Model', // 默认的模型层名称
    'DEFAULT_C_LAYER'       =>  'Controller', // 默认的控制器层名称
    'CONTROLLER_PEFEX'    => 'Controller',//控制器后缀
    ...
    'DATA_CACHE_PATH'       =>  APP_CACHE_PATH,// 缓存路径设置 (仅对File方式缓存有效)
    ...
    'TAGLIB_BUILD_IN'       =>  'wq', // 内置标签库名称(标签使用不必指定标签库名称),以逗号分隔 注意解析顺序
